  ...
  return (
    <div className="bg-[#ffffff] ">
      <div className="pl-8 pt-10">
        <img src="src/svg/Group 16.svg" alt="kanban" />
      </div>
      <nav className="flex flex-col w-[300px] h-[820px] gap-8 p-4 pl-8 pt-16">
        ...
        >
          <img
            src="src/svg/fluent_board-split-24-regular.svg"
            alt="fluent"
            width={16}
            height={16}
          />
      ...
      <div className="flex justify-around items-center bg-[#cfdefe] w-[251px] h-[48px] ml-8 mb-8 rounded-sm">
        <img src="src/svg/Combined Shape.svg" alt="combined" width={18} height={18}/>
        <input
          type="checkbox"
          value="synthwave"
          checked={darkMode}
        ...
        />
        <img src="src/svg/Combined Shape(1).svg" alt="combined" width={18} height={18}/>
      </div>
    </div>
  );
}
